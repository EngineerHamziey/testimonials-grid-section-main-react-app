  ...
  return (
    <div className='card-wrap'>
      <Card
          ...
          image={daniel}
          testimonialHeading="I received a job offer mid-course, and the subjects I learned were current, if not more so, 
        ...
        <Card
          ...
          image={jonathan}
          testimonialHeading="The team was very supportive and kept me motivated"
        ...
        <Card
          ...
          image={jeanette}
          testimonialHeading="An overall wonderful and rewarding experience"
        ...
        <Card
          ...
          image={patrick}
          testimonialHeading="Awesome teaching support from TAs who did the bootcamp themselves. Getting guidance from them and 
        ...
        <Card
          ...
          image={kira}
          testimonialHeading="Such a life-changing experience. Highly recommended!"
